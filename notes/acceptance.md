...
- `npm run check` passed: 19 Node tests, the Vite production build, and 6 Playwright tests in Chromium.
...
- `test/e2e/navigation.spec.js` checks Art/BIO/About at 320, 390, 768, and 1280 CSS pixels, the photo-derived theme tokens and v2 hero asset, minimum mobile targets, and a WebUSB CDC device with polyfill-relevant descriptors, class requests, and bulk endpoints.
